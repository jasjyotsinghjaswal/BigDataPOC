...
app_id=`oozie job -oozie http://tplhc01c001.iuser.iroot.adidom.com:11000/oozie -info ${wf_id}@${pig_action} | head -3 | tail -1 | cut -d '/' -f 5`  || check_error "Cant Retrieve job id for pig action"
...
#rm /home/pc100118/log_devel/pig_action_count/${filename}
